...
public class TrailControllerScript : MonoBehaviour
{
    public GameObject Trail;
    public BirdScript TargetBird;
    ...
    public void SetBird(BirdScript bird)
    {
        TargetBird = bird;
    ...
    public IEnumerator SpawnTrail()
    {
        ...
        if (TargetBird != null && TargetBird.State != BirdScript.BirdState.HitSomething)
        {
